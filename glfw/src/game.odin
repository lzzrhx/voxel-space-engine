...
game_render :: proc(game: ^Game) {
    ...
    font_render(game, 2, 0, 2, game.fps >= 50 ? {0.2, 0.8, 0.2} : (game.fps >= 30 ? {0.8, 0.8, 0.2} : {0.8, 0.2, 0.2} ), game.fps)
    //font_render_string(game, 2, 32, 1, {1.0, 1.0, 1.0}, "abc\\ndefghijklmnopqrst")

    //font_render(game, 2, 1080-32, 2, {1.0, 1.0, 1.0}, game.camera.txt)
    font_render_string(game, 0, 32, 1, {1.0, 1.0, 1.0}, 
